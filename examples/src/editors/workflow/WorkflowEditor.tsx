...
import WorkflowTitle from './components/title/WorkflowTitle';
import WorkflowItems from './components/item/WorkflowItems';
import WorkflowConfigurations from './components/configuration/WorkflowConfigurations';
import WorkflowNodeConfigurations from './components/configuration/WorkflowNodeConfigurations';
...
class WorkflowEditor extends Component {
	...
	render() {
		const { canvasRect, zoomRatio, workflow, selectedItem, descriptors, loading, editing } = this.state;
