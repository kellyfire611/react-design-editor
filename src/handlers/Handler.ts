...
export interface HandlerOptions {
	...
	/**
	 * When has been removed object on Canvas
	 *
	 * @author salgum1114
	 * @param {FabricObject} target
	 */
	...
	/**
	 * When has been changed interaction mode
	 *
	 * @author salgum1114
...
class Handler implements HandlerOptions {
	...
	public onMouseover?: (target: FabricObject) => void;
